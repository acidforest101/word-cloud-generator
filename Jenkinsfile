      ...
      stages {
        ...
        stage('Building code and uploading artifacts to Nexus') { 
          steps {sh '''
                 ...
                 ls ./artifacts/
                 '''
                 nexusArtifactUploader artifacts: [[artifactId: 'word-cloud-generator', classifier: '', file: 'artifacts/word-cloud-generator', type: 'gz']], credentialsId: 'upload', groupId: 'webapp', nexusUrl: '192.168.66.11:81', nexusVersion: 'nexus3', protocol: 'http', repository: 'word-cloud-generator', version: '1.$BUILD_NUMBER'
                 }
               }
             }
           }
           stage('Integration tests') {
             ...
             stages {
               stage ('Download artifact from vault and start it') {
                 steps { sh '''
                         curl -X GET -u downloader:downloader "http://192.168.66.11:81/repository/word-cloud-generator/webapp/word-cloud-generator/1.$BUILD_NUMBER/word-cloud-generator-1.$BUILD_NUMBER.gz" -o /opt/WCG/word-cloud-generator.gz
