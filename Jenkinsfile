		...
		stage('Integration tests') {
			...
			stages {
				stage ('Download artifact from vault and start it') {
					steps {
						sh '''curl -X GET -u downloader:downloader "http://192.168.66.11:8081/repository/word-cloud-generator/webapp/word-cloud-generator/1.$BUILD_NUMBER/word-cloud-generator-1.$BUILD_NUMBER.gz" -o /opt/wordcloud/word-cloud-generator.gz
